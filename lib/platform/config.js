...
export function runtimeConfig() {
  ...
  return { ...meta, extras, cloudApiExtras: extras };
}

export function signupExtras(config, signupMode) {
  if (signupMode === 'coexistence') return { setup: {}, featureType: 'whatsapp_business_app_onboarding', sessionInfoVersion: '3' };
  if (signupMode === 'cloud_api') return config.cloudApiExtras;
  throw new HttpError(400, 'invalid_signup_mode');
}
